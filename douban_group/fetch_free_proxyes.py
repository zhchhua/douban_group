...
def get_html(url):
    response = requests.get(url,headers={"User-Agent":"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.99 Safari/537.36"})	
...
def fetch_mimvp():
    ...
    try:
        ...
        print("fail to fetch from mimvp")
    return proxyes
...
def check(proxy):
    ...
    url = "http://www.douban.com/kaopulove"
